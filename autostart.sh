...
# ==============================================================================
# Gatepass Auto Start & Restarter Script (autostart.sh)
...
#
# Usage:
#   ./autostart.sh           -> Force restart, git pull, rebuild, and start
#   ./autostart.sh --monitor -> Lightweight check if down, then restart if needed
# ==============================================================================
